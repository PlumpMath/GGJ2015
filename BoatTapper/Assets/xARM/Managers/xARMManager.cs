...
public static class xARMManager {
	...
	private static void InitAvailScreenCaps(){
		...
		addOrUpdateScreenCap (new xARMScreenCap("DPoker FB build", new Vector2(720, 600), "FB Canvas1","FB1", 10, 0, "", xARMScreenCapGroup.Custom, 999, -1f, "Poker FB build canvas1"));
